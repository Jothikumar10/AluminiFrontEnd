...
function CreatePostModal({ isOpen, onClose, onPost }) {
  ...
  const handleMediaClick = (type, accept) => {
    setFileType(type);
  ...
  const handleSubmit = () => {
    ...
    const newPost = {
      ...
      job: showJob ? jobData : null,

      event: showEvent ? eventData : null,
          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 sm:px-6">
              <div>
                ...
                <p className="mt-0.5 text-xs text-slate-500">
                  Share knowledge, opportunities and achievements
                </p>
              </div>
            ...
            <div className="overflow-y-auto p-5 sm:p-6">
              ...
              <div className="relative mt-5">
                <textarea
                  ...
                  rows={6}
                  maxLength={5000}
                  className="w-full resize-none rounded-2xl border border-slate-200 bg-slate-50 p-4 pb-12 text-sm leading-6 text-slate-800 outline-none transition placeholder:text-slate-400 focus:border-indigo-400 focus:bg-white focus:ring-4 focus:ring-indigo-50"
                />
                  ...
                  {mediaOptions.map((option) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex items-center gap-2 rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-50 hover:text-indigo-600"
                      >
                        <Icon size={19} />
                        {option.label}
                      </button>
                    ...
                    {media.map((item) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="absolute right-2 top-2 flex h-8 w-8 items-center justify-center rounded-full bg-slate-950/70 text-white backdrop-blur transition hover:bg-slate-950"
                        >
                          <X size={15} />
                        </button>
                      </div>
              ...
              <div className="mt-4 flex gap-3 rounded-2xl bg-indigo-50 p-4">
                ...
                <p className="text-xs leading-5 text-indigo-700">
                  Share useful career knowledge, opportunities,
                  achievements, events, media or experiences that
                  can help the AlumniConnect community.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-slate-100 bg-slate-50/70 p-4 sm:flex-row sm:items-center sm:justify-end sm:p-5">
              <button
                type="button"
                onClick={handleClose}
                className="w-full rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-100 sm:w-auto"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="w-full rounded-xl bg-indigo-600 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-indigo-600/20 transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
              >
                Post
              </button>
            </div>
